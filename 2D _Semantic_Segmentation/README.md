...
**Context:** In ADAS, segmentation is a key task to accurately perceive and interpret surroundings. It classifies every pixel in an image into meaningful categories (e.g., road, car, pedestrian).
